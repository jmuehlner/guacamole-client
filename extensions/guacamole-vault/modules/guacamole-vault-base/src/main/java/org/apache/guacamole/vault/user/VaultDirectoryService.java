...
public interface VaultDirectoryService {
     ...
     *     If an error occurs while creating the Directory.
     */
    default Directory<UserGroup> getUserGroupDirectory(
     ...
     *     If an error occurs while creating the Directory.
     */
    default Directory<Connection> getConnectionDirectory(
     ...
     *     If an error occurs while creating the Directory.
     */
    default Directory<ConnectionGroup> getConnectionGroupDirectory(
     ...
     *     If an error occurs while creating the Directory.
     */
    default Directory<ActiveConnection> getActiveConnectionDirectory(
     ...
     *     If an error occurs while creating the Directory.
     */
    default Directory<SharingProfile> getSharingProfileDirectory(
