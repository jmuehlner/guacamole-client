...
Guacamole.KeyEventBatcher = function KeyEventBatcher(batchSeperation) {
     ...
     */
    batcher.handleKeyEvent = function handleKeyEvent(args) {
        ...
        if (newBatch) {
            ...
            if (currentTypedValue && batcher.onBatch)
                batcher.onBatch(currentTypedValue, lastTextTimestamp);
     ...
     */
    batcher.getCurrentText = function getCurrentText() {
     ...
     */
    batcher.getCurrentTimestamp = function getCurrentTimestamp() {
